...
public class GuviTask20 {
	...
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	  ...
	  WebElement profile= driver.findElement(By.id("profileDrpDwn")); Select pro =
	  new Select(profile); pro.selectByValue("Looking for a career");
	  
	  WebElement degree = driver.findElement(By.id("degreeDrpDwn")); Select degr =
	  new Select(degree); degr.selectByValue("B.B.A. / M.B.A.");
	...
	driver.findElement(By.xpath("//button[contains(@class,'btn dropdown account')]")).click();
	
	//locate the userid name 
	String Expuser = "testiduser01@gmail.com";
	
	String actuser = driver.findElement(By.xpath("//small[text()='testiduser01@gmail.com']")).getText();
