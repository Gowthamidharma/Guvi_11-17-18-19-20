	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		 ...
		 driver.findElement(By.id("email")).sendKeys("gowthamidharma@gmail.com");
		  //xpath 
		 driver.findElement(By.xpath(" //input[@type='email' ]")).sendKeys("gowthamidharma@gmail.com");
		   //css selector 
		 driver.findElement(By.cssSelector("//input#email")).sendKeys("gowthamidharma@gmail.com");
	   ...
	   //locate toogle password 
		...
		driver.findElement(By.className("form-control countrycode-left")).sendKeys("9600192572");
	    driver.findElement(By.xpath("(//input[@id='mobileNumber'])[1]")).sendKeys("9600192572"); 
		driver.findElement(By.cssSelector("//input#mobileNumber")).sendKeys("9600192572"); 
